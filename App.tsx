...
const App: React.FC = () => {
  return (
    <div className="min-h-screen">
      ...
      <main>
        {/* HERO (botão + notebook ficam AQUI, dentro do Hero.tsx) */}
        <Hero />
            ...
            <div className="flex flex-col lg:flex-row items-center gap-16">
              <div className="flex-1">
                <h2 className="text-4xl md:text-5xl font-extrabold mb-8 leading-tight">
                  A solução definitiva para quem busca{' '}
                  <span className="text-cyan-400">ordem no caos</span> da programação.
                </h2>
        ...
        {/* CHECKOUT / CTA FINAL (SEM IMAGEM AQUI) */}
        <section id="checkout" className="py-32 relative">
          ...
          <div className="max-w-3xl mx-auto px-4 text-center">
            <h2 className="text-4xl md:text-6xl font-black mb-8">
              Pare de estudar no escuro. Tenha um plano claro.
            </h2>
            ...
            <div className="bg-zinc-900 border border-cyan-500/30 p-12 rounded-[3rem] shadow-2xl relative overflow-hidden mb-10">
              ...
              <div className="mb-8">
                <p className="text-zinc-500 line-through mb-2 font-medium">
                ...
                <p className="mt-4 text-zinc-400 font-medium italic">
                  ou R$ 47,00 à vista
                </p>
              </div>
